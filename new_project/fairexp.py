...
def extend_dataframe_complete(df=None, complexity=None, scoring=None, target=None, sampling=None, train_indices=None):
...
def repair_algorithm(train, names, df_train, y_train, sensitive_feature, sensitive_features, protected, admissible_features,
    ...
    return selected_indices, selected_indices_first_phase
