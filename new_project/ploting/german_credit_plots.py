...
results = pd.read_csv(results_path + '/complete_credit_df_results_complexity_3.csv')
...
ax1.set_title('German credit results - ROD')
ax2.set_title('German credit results - F1')
