from fairlearn.metrics import MetricFrame, true_negative_rate
import numpy as np
import pandas as pd
...
def CTNB(y_test, y_pred, df, sensitive, admissible):
    ...
    for z in unique_contexts:
        ...
        if sensitive_features_.unique().shape[0] > 1:
            ...
            m = MetricFrame(true_negative_rate, y_test[ids], y_pred[ids],
