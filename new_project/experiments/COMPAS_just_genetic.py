...
if CF:
    summary_df.to_csv(path_or_buf=results_path + '/COMPAS_genetic_complexity_' + str(complexity) + '_CF' + '.csv', index=False)
    runtimes_df.to_csv(path_or_buf=results_path + '/runtimes_COMPAS_genetic_complexity_' + str(complexity) + '_CF' + '.csv',
                      index=False)
    visited_train_df.to_csv(path_or_buf=results_path + '/visited_train_COMPAS_genetic_complexity_' + str(complexity) + '_CF' + '.csv',
                      index=False)
    visited_test_df.to_csv(
        path_or_buf=results_path + '/visited_test_COMPAS_genetic_complexity_' + str(complexity) + '_CF' + '.csv',
        index=False)
else:
    summary_df.to_csv(path_or_buf=results_path + '/COMPAS_genetic_complexity_' + str(complexity) + '.csv', index=False)
    runtimes_df.to_csv(path_or_buf=results_path + '/runtimes_COMPAS_genetic_complexity_' + str(complexity) + '.csv', index=False)
    visited_train_df.to_csv(
        path_or_buf=results_path + '/visited_train_COMPAS_genetic_complexity_' + str(complexity) + '.csv',
        index=False)
    visited_test_df.to_csv(
        path_or_buf=results_path + '/visited_test_COMPAS_genetic_complexity_' + str(complexity) + '.csv',
        index=False)