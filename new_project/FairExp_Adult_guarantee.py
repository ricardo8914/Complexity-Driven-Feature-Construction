...
def adult_experiment():
    ...
    for train_index, test_index in kf1.split(adult):
        ...
        results.append(
            ['Adult', 'FairExp-guaranteed', selected_names, fold, rod_FairExp_,
    ...
    #
    #     results.append(
    #         ['Adult', 'Original', admissible_features + sensitive_features, fold, rod_original,
    ...
    #         train_index, [list(adult).index(i) for i in list(adult) if i != target and i not in sensitive_features]]
    #     dropped_test_df = adult.iloc[
    #         test_index, [list(adult).index(i) for i in list(adult) if i != target and i not in sensitive_features]]
    #
    #     features2_scale = []
    #     features2_encode = []
    ...
    #
    #     results.append(
    #         ['Adult', 'dropped', admissible_features, fold, rod_dropped,
